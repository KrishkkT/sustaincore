(function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const d of s.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&r(d)}).observe(document,{childList:!0,subtree:!0});function i(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(e){if(e.ep)return;e.ep=!0;const s=i(e);fetch(e.href,s)}})();const g=`
...
`;document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("header-root"),l=document.getElementById("footer-root");n&&(n.innerHTML=g),l&&(l.innerHTML=v);const i=document.getElementById("theme-toggle"),r=document.documentElement;(localStorage.getItem("sustain-theme")||"light")==="dark"?(r.classList.add("dark"),i&&i.setAttribute("aria-checked","true")):(r.classList.remove("dark"),i&&i.setAttribute("aria-checked","false")),i&&i.addEventListener("click",function(){r.classList.contains("dark")?(r.classList.remove("dark"),i.setAttribute("aria-checked","false"),localStorage.setItem("sustain-theme","light")):(r.classList.add("dark"),i.setAttribute("aria-checked","true"),localStorage.setItem("sustain-theme","dark"))}),(()=>{const t=document.getElementById("mobile-menu-btn"),a=document.getElementById("close-menu"),o=document.getElementById("mobile-menu");t&&o&&t.addEventListener("click",()=>{o.classList.remove("translate-x-full")}),a&&o&&a.addEventListener("click",()=>{o.classList.add("translate-x-full")}),document.querySelectorAll("#mobile-menu a").forEach(u=>{u.addEventListener("click",()=>{o&&o.classList.add("translate-x-full")})});const c=document.getElementById("mobile-services-toggle"),m=document.getElementById("mobile-services-list");c&&m&&c.addEventListener("click",()=>{m.classList.toggle("hidden"),c.querySelector("svg").classList.toggle("rotate-180")})})(),document.querySelectorAll(".flip-card").forEach(t=>{t.addEventListener("click",a=>{window.matchMedia("(max-width: 1023px)").matches&&t.classList.toggle("is-flipped")})})});document.addEventListener("DOMContentLoaded",()=>{const n=document.querySelectorAll(".tab-btn"),l=document.querySelectorAll(".panel"),i=document.querySelectorAll(".mega-item"),r=()=>{const t=document.getElementById("services-scroll-target")||document.getElementById("services-nav-anchor");t&&t.scrollIntoView({behavior:"smooth",block:"start"})},e=t=>{n.forEach(a=>{a.getAttribute("data-tab")===t?a.classList.add("active"):a.classList.remove("active")}),l.forEach(a=>{a.id===t?a.classList.add("active"):a.classList.remove("active")})};n.forEach(t=>{t.addEventListener("click",a=>{const o=t.getAttribute("data-tab");e(o),r(),history.pushState(null,null,`#${o}`)})}),i.forEach(t=>{t.addEventListener("click",a=>{const o=t.getAttribute("href");if(o&&o.includes("#")){const h=o.split("#")[1];window.location.pathname.includes("services.html")&&(a.preventDefault(),e(h),r(),history.pushState(null,null,`#${h}`))}})});const s=()=>{const t=window.location.hash.substring(1);if(t)document.querySelector(`.tab-btn[data-tab="${t}"]`)&&(e(t),setTimeout(r,100));else if(n.length>0){const a=document.querySelector(".tab-btn.active");if(a){const o=a.getAttribute("data-tab");e(o)}}};window.addEventListener("load",s),window.addEventListener("hashchange",s),document.querySelectorAll(".faq-btn, .sp-faq-btn").forEach(t=>{t.addEventListener("click",()=>{const a=t.parentElement;document.querySelectorAll(".faq-item.active, .sp-faq-item.active").forEach(o=>{o!==a&&o.classList.remove("active")}),a.classList.toggle("active")})})});const x=()=>{let n=document.querySelector(".toast-container");return n||(n=document.createElement("div"),n.className="toast-container",document.body.appendChild(n)),n};window.showToast=(n,l,i="success")=>{const r=x(),e=document.createElement("div");e.className=`toast toast-${i}`;const s=i==="success"?'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>':'<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>';e.innerHTML=`
    ...
    `,r.appendChild(e),setTimeout(()=>e.classList.add("show"),100);const d=()=>{e.classList.remove("show"),setTimeout(()=>e.remove(),600)},t=setTimeout(d,5e3);e.querySelector(".toast-close").addEventListener("click",()=>{clearTimeout(t),d()})};window.handleSubmit=async function(n){n.preventDefault();const l=n.target,i=new FormData(l),r=l.querySelector('button[type="submit"]'),e=r.innerHTML;r.disabled=!0,r.innerHTML="Sending...";try{const s=await fetch(l.action,{method:l.method,body:i,headers:{Accept:"application/json"}});if(s.ok)window.showToast("Message Sent","Thank you! Our technical team will reach out shortly.","success"),l.reset();else{const d=await s.json();window.showToast("Submission Error",d.errors?d.errors[0].message:"Unable to send message. Please try again.","error")}}catch{window.showToast("System Offline","Could not connect to the server. Please check your internet.","error")}finally{r.disabled=!1,r.innerHTML=e}};
