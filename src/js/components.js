...
<nav class="fixed top-0 left-0 right-0 mx-auto w-[92%] max-w-6xl z-50 bg-white/80 backdrop-blur-xl border border-brand-softGray shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl px-6 py-4 flex items-center justify-between transition-all duration-300" id="main-nav">
  ...
  <div class="hidden lg:flex items-center gap-8 navbar-items">
    ...
    <div class="nav-item-services group/mega" id="nav-services-dropdown">
      <a href="/services" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200 flex items-center gap-1 cursor-pointer" id="nav-services-toggle">
      ...
      <div class="mega-menu">
        <a href="/esg-reporting" class="mega-item">
          <div>
        ...
        <a href="/carbon-climate" class="mega-item">
          <div>
        ...
        <a href="/clearances-eia" class="mega-item">
          <div>
        ...
        <a href="/ratings-targets" class="mega-item">
          <div>
        ...
        <a href="/management-systems" class="mega-item">
          <div>
        ...
        <a href="/water-testing" class="mega-item">
          <div>
        ...
        <a href="/air-monitoring" class="mega-item">
          <div>
    ...
    <a href="/cbam" title="CBAM Advisory" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200" data-i18n="navbar.cbam">CBAM</a>
    <a href="/insights" title="Sustainability Insights" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200" data-i18n="navbar.insights">Insights</a>
    <a href="/join-us" title="Careers at SustainCore" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200" data-i18n="navbar.careers">Careers</a>
    <a href="/partners" title="SustainCore Partners" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200" data-i18n="navbar.partners">Partners</a>
    <a href="/about" title="About SustainCore Ahmedabad, Germany & Europe" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green transition-colors duration-200" data-i18n="navbar.about">About Us</a>
    ...
    <a href="/contact" class="px-5 py-2 bg-brand-green text-white rounded-full text-[12px] font-bold tracking-wide uppercase hover:bg-brand-blue hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300" data-i18n="navbar.cta">Free Consultation</a>
  </div>
...
<div id="mobile-menu" class="fixed inset-0 z-50 bg-white transform translate-x-full transition-transform duration-500 lg:hidden flex flex-col pt-32 px-6 gap-4 overflow-y-auto">
    ...
    <div id="mobile-services-list" class="hidden flex flex-col gap-2 px-3">
      <a href="/esg-reporting" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.esg_reporting">ESG Reporting</a>
      <a href="/carbon-climate" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.carbon_management">Carbon Management</a>
      <a href="/ratings-targets" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.ratings_title">Sustainability Ratings</a>
      <a href="/clearances-eia" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.GPCB_compliance">GPCB Compliance</a>
      <a href="/management-systems" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.environmental_audits">Environmental Audits</a>
      <a href="/water-testing" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.water_testing">Water Testing</a>
      <a href="/air-monitoring" class="text-base font-medium text-slate-700 py-2" data-i18n="navbar.air_monitoring">Air Monitoring</a>
    </div>
    <a href="/cbam" class="text-xl font-display font-bold text-slate-900 py-3 border-b border-slate-100" data-i18n="navbar.cbam">CBAM</a>
    <a href="/about" class="text-xl font-display font-bold text-slate-900 py-3 border-b border-slate-100" data-i18n="navbar.about">About Us</a>
    <a href="/insights" class="text-xl font-display font-bold text-slate-900 py-3 border-b border-slate-100" data-i18n="navbar.insights">Insights</a>
    <a href="/contact" class="mt-4 px-8 py-4 bg-brand-green text-white rounded-full text-xl font-bold text-center shadow-xl shadow-brand-green/20" data-i18n="navbar.contact">Contact Us</a>
...
<footer class="bg-brand-softGray text-brand-charcoal pt-14 pb-8 border-t border-slate-200">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[320px_1fr_1fr_1fr] gap-10 mb-10">
    <div class="flex flex-col items-start text-left sm:col-span-2 lg:col-span-1 max-w-sm">
      <div class="flex items-center gap-2 mb-4 group">
       <a href="/" class="flex items-center gap-3 group notranslate">
         <img src="/favicon.svg" alt="SustainCore Symbol - Environmental Solutions" title="SustainCore - Sustainability Simplified" class="h-12 w-auto filter drop-shadow-sm group-hover:scale-105 transition-transform duration-300">
         <img src="/main_logo_bgremoved.svg" alt="SustainCore Wordmark - ESG and Regulatory Consulting" title="SustainCore - Expert ESG Consulting" class="h-14 w-auto filter drop-shadow-sm group-hover:scale-105 transition-transform duration-300">
        </a>
      </div>
      <p class="text-slate-500 leading-relaxed mb-6 text-sm" data-i18n="footer.tagline">
        SustainCore, founded by <strong>Ritul Bhuva</strong>, is defining the future of verified sustainability and <strong>Environmental Solutions</strong> across India and Europe.
      </p>
    ...
    <div class="space-y-4">
      ...
      <li><a href="/cbam" class="hover:text-brand-blue transition-colors" data-i18n="footer.cbam_advisory">CBAM Advisory</a></li>
        <li><a href="/esg-reporting" class="hover:text-brand-blue transition-colors" data-i18n="footer.esg_reporting">ESG Reporting</a></li>
        <li><a href="/clearances-eia" class="hover:text-brand-blue transition-colors" data-i18n="footer.GPCB_compliance">GPCB Compliance</a></li>
        <li><a href="/carbon-climate" class="hover:text-brand-blue transition-colors" data-i18n="footer.carbon_management">Carbon Management</a></li>
        <li><a href="/ratings-targets" class="hover:text-brand-blue transition-colors" data-i18n="footer.ratings_targets">Ratings & Targets</a></li>
        <li><a href="/management-systems" class="hover:text-brand-blue transition-colors" data-i18n="footer.environmental_audits">Environmental Audits</a></li>
        <li><a href="/water-testing" class="hover:text-brand-blue transition-colors" data-i18n="footer.water_testing">Water Testing</a></li>
        <li><a href="/air-monitoring" class="hover:text-brand-blue transition-colors" data-i18n="footer.air_monitoring">Air Monitoring</a></li>
      </ul>
    </div>
    ...
    <div class="space-y-4">
      ...
      <ul class="flex flex-wrap gap-x-6 gap-y-3 justify-center lg:flex-col lg:gap-0 lg:space-y-2.5 text-sm text-slate-500">
        <li><a href="/about" class="hover:text-brand-blue transition-colors" data-i18n="footer.about_sustaincore">About SustainCore</a></li>
        <li><a href="/insights" class="hover:text-brand-blue transition-colors" data-i18n="footer.latest_insights">Latest Insights</a></li>
        <li><a href="/join-us" class="hover:text-brand-blue transition-colors" data-i18n="footer.career_opportunities">Career Opportunities</a></li>
        <li><a href="/partners" class="hover:text-brand-blue transition-colors" data-i18n="footer.our_partners">Our Partners</a></li>
        <li><a href="/contact" class="hover:text-brand-blue transition-colors" data-i18n="footer.contact_support">Contact Support</a></li>
      </ul>
    </div>

    <div class="space-y-4 lg:w-[110%]">
      <h4 class="font-display font-bold text-brand-blue tracking-wide uppercase text-xs" data-i18n="footer.newsletter_title">Stay Updated</h4>
      <p class="text-slate-500 text-sm leading-relaxed mb-4" data-i18n="footer.newsletter_desc">
        Get the latest sustainability updates and news delivered to your inbox.
      </p>
      <form id="subscribe-form" class="space-y-3">
        <input type="email" name="email" placeholder="Email Address" required data-i18n-attr="placeholder:footer.email_placeholder" class="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-brand-green/30 text-sm transition-all">
  ...
  <div class="max-w-7xl mx-auto px-6 pt-8 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between gap-6 text-slate-400 text-[12px] font-medium">
    ...
    <div class="flex gap-8 items-center">
      <a href="/imprint" class="hover:text-brand-blue transition-colors" data-i18n="footer.imprint">Imprint</a>
      <a href="/privacy" class="hover:text-brand-blue transition-colors" data-i18n="footer.privacy">Privacy Policy</a>
    </div>
  </div>
</footer>
`;
