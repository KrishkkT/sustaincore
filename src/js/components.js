...
<nav class="fixed top-0 left-0 right-0 mx-auto w-[92%] max-w-6xl z-50 bg-white/80 dark:bg-slate-900/90 backdrop-blur-xl border border-brand-softGray dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] rounded-2xl px-6 py-4 flex items-center justify-between transition-all duration-300" id="main-nav">
  ...
  <div class="hidden md:flex items-center gap-8 navbar-items">
    <a href="/" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.home">Home</a>
    ...
    <a href="/cbam.html" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.cbam">CBAM</a>
    <a href="/about.html" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.about">About</a>
    <a href="/insights.html" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.insights">Insights</a>
    <a href="/join-us.html" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.careers">Careers</a>
    <a href="/partners.html" class="text-[13px] font-semibold tracking-wide uppercase text-slate-600 hover:text-brand-green dark:text-slate-300 dark:hover:text-brand-green transition-colors duration-200" data-i18n="navbar.partners">Partners</a>
      ...
      <div class="absolute top-full right-0 mt-2 w-48 bg-white dark:bg-slate-900 border border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden opacity-0 invisible group-hover/lang:opacity-100 group-hover/lang:visible transition-all duration-300 z-[60] translate-y-2 group-hover/lang:translate-y-0">
        <div class="p-2 grid grid-cols-1 gap-1">
          <button class="lang-option flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-left" data-lang="en" data-flag="🇺🇸">
            ...
            <span class="text-[13px] font-medium text-slate-700 dark:text-slate-300" data-i18n="navbar.lang_en">English</span>
          </button>
          <button class="lang-option flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-left" data-lang="de" data-flag="🇩🇪">
            <span class="text-base">🇩🇪</span>
            <span class="text-[13px] font-medium text-slate-700 dark:text-slate-300" data-i18n="navbar.lang_de">Deutsch (German)</span>
          </button>
          <button class="lang-option flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-left" data-lang="fr" data-flag="🇫🇷">
            <span class="text-base">🇫🇷</span>
            <span class="text-[13px] font-medium text-slate-700 dark:text-slate-300" data-i18n="navbar.lang_fr">Français (French)</span>
          </button>
          <button class="lang-option flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-white/5 transition-colors text-left" data-lang="es" data-flag="🇲🇽">
            <span class="text-base">🇲🇽</span>
            <span class="text-[13px] font-medium text-slate-700 dark:text-slate-300" data-i18n="navbar.lang_es">Español (Spanish)</span>
          </button>
        </div>
      </div>
    </div>
...
<div id="mobile-menu" class="fixed inset-0 z-50 bg-white dark:bg-slate-900 transform translate-x-full transition-transform duration-500 md:hidden flex flex-col pt-32 px-6 gap-4">
    ...
    <a href="/" class="text-xl font-display font-bold text-slate-900 dark:text-white py-3 border-b border-slate-100 dark:border-slate-800" data-i18n="navbar.home">Home</a>
    ...
    <div id="mobile-services-list" class="hidden flex flex-col gap-2 px-3">
      <a href="/esg-reporting.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.esg_reporting">ESG Reporting</a>
      <a href="/carbon-climate.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.carbon_management">Carbon Management</a>
      <a href="/ratings-targets.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.ratings_title">Sustainability Ratings</a>
      <a href="/clearances-eia.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.spcb_compliance">SPCB Compliance</a>
      <a href="/management-systems.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.environmental_audits">Environmental Audits</a>
      <a href="/water-testing.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.water_testing">Water Testing</a>
      <a href="/air-monitoring.html" class="text-base font-medium text-slate-700 dark:text-slate-300 py-2" data-i18n="navbar.air_monitoring">Air Monitoring</a>
    </div>
    <a href="/cbam.html" class="text-xl font-display font-bold text-slate-900 dark:text-white py-3 border-b border-slate-100 dark:border-slate-800" data-i18n="navbar.cbam">CBAM</a>
    <a href="/about.html" class="text-xl font-display font-bold text-slate-900 dark:text-white py-3 border-b border-slate-100 dark:border-slate-800" data-i18n="navbar.about">About</a>
    <a href="/insights.html" class="text-xl font-display font-bold text-slate-900 dark:text-white py-3 border-b border-slate-100 dark:border-slate-800" data-i18n="navbar.insights">Insights</a>
...
<footer class="bg-brand-softGray dark:bg-slate-900 text-brand-charcoal dark:text-slate-300 pt-14 pb-8 border-t border-slate-200 dark:border-slate-800">
  <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-[320px_1fr_1fr_1fr] gap-6 mb-10">
    <div class="flex flex-col items-start text-left max-w-[280px]">
      ...
      <p class="text-slate-500 dark:text-slate-400 leading-relaxed mb-3 text-sm" data-i18n="footer.tagline">
        Defining the future of verifiable sustainability through scientific integrity and data transparency.
      </p>
      <div class="flex gap-2">
     <!-- LinkedIn -->
<a href="https://linkedin.com" aria-label="LinkedIn"
  class="w-9 h-9 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-blue-600 hover:text-white hover:border-transparent transition-all">
  ...
  <a href="https://instagram.com" class="w-9 h-9 rounded-full border border-slate-200 dark:border-slate-700 flex items-center justify-center hover:bg-pink-500 hover:text-white hover:border-transparent transition-all">
    ...
    <div>
      <h4 class="font-display font-bold text-brand-blue dark:text-brand-green mb-3 tracking-wide" data-i18n="footer.solutions">Solutions</h4>
      <ul class="space-y-2 text-sm text-slate-500 dark:text-slate-400">
        <li><a href="/esg-reporting.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.esg_reporting">ESG Reporting</a></li>
        <li><a href="/carbon-climate.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.carbon_management">Carbon Management</a></li>
        <li><a href="/ratings-targets.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.ratings_title">Ratings & Targets</a></li>
        <li><a href="/clearances-eia.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.spcb_compliance">SPCB Compliance</a></li>
        <li><a href="/management-systems.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.environmental_audits">Environmental Audits</a></li>
        <li><a href="/water-testing.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.water_testing">Water Testing</a></li>
        <li><a href="/air-monitoring.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.air_monitoring">Air Monitoring</a></li>
      </ul>
    </div>

    <div>
      <h4 class="font-display font-bold text-brand-blue dark:text-brand-green mb-3 tracking-wide" data-i18n="footer.company">Company</h4>
      <ul class="space-y-2 text-sm text-slate-500 dark:text-slate-400">
        <li><a href="/about.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.mission">Our Mission</a></li>
        <li><a href="/cbam.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.cbam">CBAM Advisory</a></li>
        <li><a href="/insights.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.insights">Insights</a></li>
        <li><a href="/join-us.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.careers">Careers</a></li>
        <li><a href="/partners.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.partners">Partners</a></li>
        <li><a href="/contact.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.get_in_touch">Contact</a></li>
      </ul>
    </div>

    <div>
      <h4 class="font-display font-bold text-brand-blue dark:text-brand-green mb-3 tracking-wide" data-i18n="footer.connect">Connect</h4>
      <form id="subscribe-form" class="space-y-2">
        <input type="email" name="email" required placeholder="Email Address" class="w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-brand-green/30 dark:focus:ring-brand-green/50 text-sm" data-i18n-attr="placeholder:footer.email_placeholder">
        <button type="submit" class="w-full py-2.5 bg-brand-charcoal dark:bg-brand-green text-white rounded-xl font-bold hover:bg-brand-blue dark:hover:bg-[#3d694b] transition-all tracking-wider text-[13px] uppercase" data-i18n="footer.subscribe">SUBSCRIBE</button>
      </form>
    </div>
  </div>
  ...
  <div class="max-w-7xl mx-auto px-6 pt-3 border-t border-slate-200 dark:border-slate-800 flex flex-col md:flex-row items-center justify-between gap-3 text-slate-500 dark:text-slate-400 text-[13px]">
    ...
    <div class="flex gap-8">
      <a href="/imprint.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.imprint">Imprint</a>
      <a href="/privacy.html" class="hover:text-brand-blue dark:hover:text-white transition-colors" data-i18n="footer.privacy">Privacy Policy</a>
    </div>
  </div>
</footer>
`;
